...
TextRenderer::TextRenderer(const char* font)
{
	...
	// This code is taken from learnOpenGL.com
...
void TextRenderer::RenderText(Shader& s, std::string text, float x, float y, float scale, glm::vec3 color, float width, float height)
{
